...
treeview.insert('item4', 'end', 'test',
				text ='test')

treeview.insert('item5', 'end', 'Algorithmq',
				text ='Algorithm')
treeview.insert('item5', 'end', 'Data structureq',
				text ='Data structure')
...
treeview.bind('<ButtonPress>', lambda e: print('ok',e.focus))
