...
framehome = tk.Frame(root)
frame3 = tk.Frame(root)

for frame in (framehome, frame3):
    frame.grid(row=0, column=0, sticky='nsew')
# =============================Frame1 code====================================================
frame1_title = tk.Label(framehome, text='this is frame 1', bg='red')
frame1_title.pack(fill='x')

frame1_btn = tk.Button(framehome, text='enter', command=lambda: show_frame(frame3))
frame1_btn.pack()
...
f1 = tk.Frame(frame3, bg="#e6e6e6", borderwidth=2, width=280, relief=SUNKEN)
f1.pack(side=LEFT, fill="y")
f1.pack_propagate(0)

frame1 = tk.LabelFrame(frame3, text="Excel Data", height=500, width=500, )
frame1.pack(side=BOTTOM, fill="x", anchor="sw")
frame1.pack_propagate(0)

# Frame for open file dialog
file_frame = tk.LabelFrame(frame3, text="Open File")
